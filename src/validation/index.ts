...
export abstract class BaseValidator {
    ...
    constructor(valueFrom: GET_VALUE_FROM = 'body', excludeFieldsThatAreNotInSchema=true){
        this.validateDataFrom = valueFrom;
        this.excludeFieldsThatAreNotInSchema = excludeFieldsThatAreNotInSchema;
        
    }

    public excludeUnknownFields(data: Record<string,any>){
    ...
    public middleware = (req: RequestType, res: Response, next)=> {
        let data;
